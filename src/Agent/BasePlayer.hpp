...
public:
     ...
     * @details Realiza a reserva de memória no vetor estático, define o número
     * do uniforme, executa o protocolo de handshake e registra o comunicador deste
     * jogador na lista global.
