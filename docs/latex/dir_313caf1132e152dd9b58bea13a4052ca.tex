...
\item 
file \mbox{\hyperlink{RobotPositionManager_8py}{Robot\+Position\+Manager.\+py}}
\begin{DoxyCompactList}\small\item\em Implementação de lógica organizadora de posições iniciais de partida. \end{DoxyCompactList}\end{DoxyCompactItemize}
